...
def render_text_simulation_speed(screen, font, simulation_speed):
    if simulation_speed >= 100_000:
        simulation_speed = str(simulation_speed)[:-2]
    elif simulation_speed >= 10_000:
        simulation_speed = str(simulation_speed)[:-2] + "." + str(simulation_speed)[-2]
    elif simulation_speed >= 100:
        simulation_speed =  str(simulation_speed)[-3::-1][::-1] + "." +  str(simulation_speed)[-1:-3:-1][::-1]
    elif simulation_speed >= 10:
        simulation_speed = f"0.{simulation_speed}"
    else:
        simulation_speed = f"0.0{simulation_speed}"
...
def return_buttons(screen, cursor_pos, screen_size, font, controller: TextInputController, running:bool):
    return [
    ...
    text_input(screen=screen, input_name='select_position_y', cursor_pos=cursor_pos, text="Select Position Y",
        ...
        text_input(screen=screen, input_name='select_scale_position_y', cursor_pos=cursor_pos, text="10^",
                   color=neutral_color, font=font,
                   rect_info=Rect(screen_size[0] - 270, screen_size[1] - 110, 50, 40), fill_color=Color(100, 100, 150),
                   active=controller.selected == "select_scale_position_y",
                   entered_text=controller.scale_position_y_text),
    text_input(screen=screen, input_name='select_position_x', cursor_pos=cursor_pos, text="Select Position X",
        ...
        text_input(screen=screen, input_name='select_scale_position_x', cursor_pos=cursor_pos, text="10^",
                   color=neutral_color, font=font,
                   rect_info=Rect(screen_size[0] - 270, screen_size[1] - 160, 50, 40), fill_color=Color(100, 100, 150),
                   active=controller.selected == "select_scale_position_x", entered_text=controller.scale_position_x_text),
    ...
    text_input(screen=screen, input_name='select_mass', cursor_pos=cursor_pos, text="Select Mass",
        ...
        text_input(screen=screen, input_name='select_scale_mass', cursor_pos=cursor_pos, text="10^",
                   color=neutral_color, font=font,
                   rect_info=Rect(screen_size[0] - 270, screen_size[1] - 260, 50, 40), fill_color=Color(100, 100, 150),
                   active=controller.selected == "select_scale_mass", entered_text=controller.scale_mass_text),
    text_input(screen=screen, input_name='select_velocity', cursor_pos=cursor_pos, text="Select Velocity",
        ...
        text_input(screen=screen, input_name='select_scale_velocity', cursor_pos=cursor_pos, text="10^",
                   color=neutral_color, font=font,
                   rect_info=Rect(screen_size[0] - 270, screen_size[1] - 310, 50, 40), fill_color=Color(100, 100, 150),
                   active=controller.selected == "select_scale_velocity", entered_text=controller.scale_velocity_text),
    ...
    render_double_triangle_icon_button(screen=screen, button_name='double_increase_speed', cursor_pos=cursor_pos,
                                           color=Color(20, 60, 100),
                                           rect_info=Rect(screen_size[0] - 260, 10, 40, 40)),
    render_triangle_icon_button(screen=screen, button_name='increase_speed', cursor_pos=cursor_pos,
                                color=Color(20, 60, 100),
        ...
        render_double_triangle_icon_button(screen=screen, button_name='double_decrease_speed', cursor_pos=cursor_pos,
                                           color=Color(20, 60, 100),
                                           rect_info=Rect(screen_size[0] - 580, 10, 40, 40)),
        render_triangle_icon_button(screen=screen, button_name='decrease_speed', cursor_pos=cursor_pos,
                                    color=Color(20, 60, 100),
        ...
        render_stop_resume_icon_button(screen=screen, button_name='stop_resume', cursor_pos=cursor_pos,
                                    color=Color(20, 60, 100),
                                    rect_info=Rect(screen_size[0] - 420, 60, 40, 40), running=running)
