...
def draw_vector(screen, start_pos, length, angle): # (length^2)/2 = x^2
    ...
    arrow_1_x = math.cos(arrow_1_angle) * 40
    arrow_1_y = math.sin(arrow_1_angle) * 40
    arrow_2_x = math.cos(arrow_2_angle) * 40
    arrow_2_y = math.sin(arrow_2_angle) * 40

    arrow_1_end = Vector2(end_pos.x + arrow_1_x, end_pos.y + arrow_1_y)
    arrow_2_end = Vector2(end_pos.x + arrow_2_x, end_pos.y + arrow_2_y)
    print("arrow_1_end", arrow_1_end, "arrow_2_end", arrow_2_end)
